...
<form method="post" action="salesadd.php">
  ...
  <br><br>
   ...
   border: 2px solid rgba(249, 105, 14, 1);border-radius:5px;" required>
  <br><br>
  <input type="text" name="total" placeholder="total" style="width:100%;height:30px;
    border: 2px solid rgba(249, 105, 14, 1);border-radius:5px; " required>
...
$sql = "INSERT INTO sales_details( sd_id,cs_id,date,total)
VALUES ('$id','$cs_id','$date','$total')";
