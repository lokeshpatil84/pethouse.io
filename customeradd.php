...
<fieldset> 
  ...
  <br><br>
 <input type="text" name="name" placeholder="Enter customer Full name" style="width:100%;height:30px;
    border: 2px solid #b40a70; border-radius:5px; background:transparent;" required>
  <br><br>
   <input type="text" name="contact" placeholder="Enter customer contact no" style="width:100%;height:30px;
    border: 2px solid  #b40a70; border-radius:5px; background:transparent;" required>
...
$sql = "INSERT INTO customer( cs_id,cs_fname,cs_minit,cs_address)
VALUES ('$id','$fname','$minit','$address')";
